...
public class BaseDataSourceConfiguration {
    ...
    protected SqlSessionFactoryBean createSqlSessionFactoryBean(DataSource dataSource, String typeAliasesPackage) {
        SqlSessionFactoryBean sqlSessionFactoryBean = new SqlSessionFactoryBean();
        initSqlSessionFactoryBean(dataSource, typeAliasesPackage, sqlSessionFactoryBean);
        return sqlSessionFactoryBean;
    }

    protected PlatformTransactionManager createPlatformTransactionManager(DataSource dataSource) {
